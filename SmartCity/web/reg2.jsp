...
//            }
                ...
                String str1 = "insert into emp(f_name,l_name,ad_no,ph_no,address,gender,job,id_proof,email,password,availability,emp_status) values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','" + fn + "','" + value[7] + "','" + value[8] + "','1','Added')";
