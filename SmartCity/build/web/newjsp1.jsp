<%-- 
    Document   : newjsp1
    Created on : 28-Nov-2022, 7:49:19 pm
    Author     : archa
--%>
	...
	<!-- Top box -->
		...
		<main>
			...
			<div class="tm-paging-links">
				<nav>
					<ul>
						<li class="tm-paging-item"><a href="#college" class="tm-paging-link active">College</a></li>
			...
			<!-- Gallery -->
                        <!-- comment <div class="row tm-gallery">
				<!-- gallery page 1 -->
                                <section id="college">
				<div id="tm-gallery-page-college" class="tm-gallery-page">
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
                                ...
                                <table>
                                    <%
                                       String Selq="select *from location_details";
                                    ...
                                    <tr>
                                        <td><%=id%></td>
                                        <td><img src="../images/<%=image%>" height="50" width="50"></td>
                                        <td><%=name%></td>
                                        <td><%=address%></td>
                                        <td><%=contact%></td>
                                        <td><%=contact%></td>
